...
image_path = 'C:\\Users\\sainmi53\\Desktop\\images1\\image{}.jpg'.format(59)
...
lines = cv2.HoughLinesP(isolated, 2, np.pi/180, 10, np.array([]), minLineLength=80, maxLineGap=12)
points = []
for line in lines:
    points.append(line.reshape(4))
averaged_lines = average(copy, lines)
black_lines = display_lines(copy, points)
